			...
			<div  class="col-sm-1 col-md-1 col-lg-1"  >
				...
				<div  class="col-sm-10 col-md-10 col-lg-10">
					<div  class="col-lg-12" style="width:100%; padding-top:5px; padding-left:5px; padding-bottom:10px; background-color:grey;margin-bottom:1%">
						<h3 style="text-align:center;color:white">The Profiler  - List Of All Goods In Stock</h3>
					...
					<div  class="col-sm-12 col-md-12 col-lg-12"  class="col-lg-12" style="width:100%;  padding:10px; background-color:CadetBlue;margin-bottom:1%;">
							<?php
											...
											$dateprint = "For : ".$J.", ".$Q;	
											echo '<h4 style="text-align:left;color:yellow">List Of All Goods In Stocks - '.$dateprint.'</h4>';
											...
											while ($row_retrieve = mysql_fetch_array($retval, MYSQL_ASSOC)) 
											{
												...
												$data=$data.'<tr >
																	...
																	<td><a style="color:yellow" data-toggle="tooltip" data-placement="bottom"    href="Edit_Goods_Details.php?former_trans_code='.$row_retrieve['product_id'].'"  title="Click To Edit Records" >-Edit-</a></td>
															</tr>';
													$j =$j +1;
											}
											echo $data.'</table>';
											...
											if ($total_pages > 1)
											{
												...
												{
												echo ' <li><a href=Edit_Goods_In_Stock.php?page='.$previous_page.'>&laquo; </a> </li>';
												}
												 ...
												 for($i = 1; $i <= $total_pages; $i++)
												 {
													...
													//then it sset the i to be active or focused
													 ...
													 //display the page number
														echo ' <li><a href=Edit_Goods_In_Stock.php?page='.$i.'> '. $i .' </a></li>';
													 }
												 }
												//this is for next record		
												if ($has_next_page)
												{
													echo ' <li><a href=Edit_Goods_In_Stock.php?page='.$next_page.'>&raquo;</a></li> ';
												}
