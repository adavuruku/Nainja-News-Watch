...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit']))
{
	...
	$stmt = $conn->prepare("SELECT * FROM admin_user where Password=? AND User_Name=? Limit 1");
...
<title>Admin | Nainja News Watch  </title>
...
<div class="navbar navbar-inverse navbar-fixed-top" style="background-color:green" role="navigation" >
            <div class="navbar-header" style="background-color:grey">
				...
				<a class="navbar-brand" style="font-size:20px;font-weight:bold;color:white" href="../inex.php">Nainja News Watch Journalist Page </a>
		...
		<div class="row">
			<div class="col-xs-3 col-sm-3"></div>	
				<div class="col-xs-7 col-sm-7" >
					<footer>
						<p style="text-align:center">Copyright &copy; 2017 - All Rights Reserved - Software Development Unit, S O S M S.</p>
					</footer>
				</div>
