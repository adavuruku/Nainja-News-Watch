...
<div class="container" style="padding-top:5px;">
	<!-- middle content starts here where vertical nav slides and news ticker statr -->
		<div class="row">
				...
				<div  class="col-sm-12 col-md-12 col-lg-12">
					<div  class="col-lg-12" style="width:100%; padding-top:5px; padding-left:5px; padding-bottom:10px; background-color:grey;margin-bottom:1%">
						<h3 style="text-align:center;color:white">Nainja News Watch - Delete News</h3>
					...
					<div  class="col-sm-12 col-md-12 col-lg-12"  class="col-lg-12" style="width:100%; color:white; padding:10px; background-color:CadetBlue;margin-bottom:1%;">
							<?php
											...
											mysql_select_db('nainjanewswatch');
											/* Get total number of records */
											$sql    = "SELECT count(id) FROM news where author ='".$_SESSION['Admin_user_full_name']."'";
											...
											$status="0";
											$sql = "(SELECT * FROM news where author='".$_SESSION['Admin_user_full_name']."'And status='".$status."' ORDER BY id DESC LIMIT {$per_page} OFFSET {$offset})"; 
											$retval = mysql_query($sql, $conn_two);
											if (!$retval) {
												die('Could not get data: ' . mysql_error());
											}else{
											...
											/*	$formattedNum_one =  number_format($row_retrieve['price'], 2);
												 ...
												 */
												 ...
												 $body = $subj."...";
												 $news_info = htmlspecialchars_decode(strip_tags($body));
												$data=$data.'<tr >
																	<td>'.$j.'</td>
																	...
																	<td style="cursor:pointer;" title="Delete_Item" style="color:yellow" onclick="delete_Cart_Two(\''.$row_retrieve['news_id'].'\',\''.$row_retrieve['news_head'].'\')">
																	<img src="../settings/images/delete-icon.jpg" style="height:20px" ></img></td>
															</tr>';
													$j =$j +1;
											}
											echo $data.'</table>';
		...
		<div class="row" >
				<div class="col-xs-12 col-sm-12" style="background-color:grey;" >
					<footer>
