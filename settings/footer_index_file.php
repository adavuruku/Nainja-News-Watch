...
<div class="row" style="margin-bottom:10px;margin-top:10px;border-width:2px solid;">
        ...
        <div class="row" style="margin-bottom:10px;margin-top:10px;border-width:2px solid;">
            <div class="col-xs-12" style="padding-bottom:10px;padding-top:10px;background-color:white;">
				<h5 style="color:white;font-weight:bold;background-color:grey;padding:15px 0px 15px 10px"><strong>NINJA VIDEOS ...<strong></h5>
					<hr />
                <!-- Sponsored News-->
				<?php
					$stmt_in = $conn->prepare("SELECT * FROM news where category =? order by id desc limit 4");
					...
					{	
						...
						while($row_two_in = $stmt_in->fetch(PDO::FETCH_ASSOC))
						{
							...
							foreach ($dir as $fileinfo) 
							{
								...
								//$subj_two = htmlspecialchars_decode($row_two_in['news_info']);
								//$body_here =substr($subj_two,0,300);
								$date_two_1 = '<h5 style="color:black;"><strong><span style="color:red;">[Watch Video] </span> '.$row_two_in['news_head'].'</strong></h5>';
								$date_two = $date_two_1. '<p style="color:red;">'.$date_two.'</p>';
								if($row_two_in['credited'] !=""){
									$date_two = $date_two. '<p style="color:blue;"> By : '.$row_two_in['credited'].'</p>';
								}
									$date_two = $date_two. '<p style="color:blue;"> Uploaded By : '.$row_two_in['author'].'</p>';
								...
								if (!$fileinfo->isDot()) 
								{
									...
									$poster=null;
									if(substr_count($picky,"news_file") > 0){
										$poster="poster=resourcefile/News_Files/".$row_two_in['news_id']."/".$picky.'"';
									}
									...
									if(substr_count($picky,"news_file") <= 0){
										...
										$the_file_3 =$the_file_3.'<a style="color:black;text-decoration:none;font-weight:bold;" href="'.$path_two.'">
															<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3" style="padding-bottom:10px;padding-top:10px;margin-bottom:5px;border-right-width:1px;border-right-style:dashed;padding-bottom:5px">
																<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
																	<video width="auto" controls="controls" poster="resourcefile/News_Files/29975772415924/news_file.jpg" preload="true" >
																		<source src="resourcefile/News_Files/'.$row_two_in['news_id']."/".$picky.'" type="video/mp4">
  																		<source src="resourcefile/News_Files/'.$row_two_in['news_id']."/".$picky.'" type="video/ogg">
  																		<source src="resourcefile/News_Files/'.$row_two_in['news_id']."/".$picky.'" type="video/webm">
				...
				?>
				<p style="text-align:right;margin-top:10px"><a href="view_more_news.php?news_c=Videos" class="btn btn-primary"> View More &raquo; </a></p>
				<!-- Sponsored News-->
            </div>
        </div>
		<div class="row" style="margin-bottom:10px;margin-top:10px;border-width:2px solid;">
