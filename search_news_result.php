	...
	<?php require_once 'settings/header_file.php';?>
		...
		<div class="row" >
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background-color:white;">
				<h5 style="border-bottom-right-radius:2em;border-top-right-radius:2em;background:#dddddd;padding: 10px 0px 10px 10px;color:red;"><b>Home &raquo; SEARCH RESULT FOR <span style="color:blue;"><?php echo strtoupper($hide);?> NEWS !!</span></b></h5>
				<hr/>
			</div>
			<!-- cont before news -->
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" style="background-color:#eeeeee;">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top:10px;background-color:white;">
						<p style="color:red;font-weight:bold;background-color:white;padding:15px 0px 0px 10px;"><strong>SEARCH RESULT FOR  <?php echo strtoupper($hide);?> NEWS !! &raquo;<strong></p>
						<hr/>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
					<?php
						
							$stmt_ina = $conn->prepare("SELECT * FROM news where news_head like ? or news_info like ?");
							$stmt_ina->execute(array("%$hide%","%$hide%"));
						...
						$has_next_page = $next_page <= $total_pages ? true : false;
										...
										//SEARCH FOR
											...
											$stmt_in = $conn->prepare("SELECT * FROM news where news_head like ? or news_info like ? ORDER BY id DESC Limit {$per_page} OFFSET {$offset} ");
											//$stmt_in->execute(array($news_c));
											$stmt_in->execute(array("%$hide%","%$hide%"));
			...
			<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="background-color:white;border:2px;">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top:10px">
					...
					<?php 
						$my_file_two ="";
						$stmt = $conn->prepare("SELECT * FROM news where news_type=? ORDER BY id DESC Limit 10");
